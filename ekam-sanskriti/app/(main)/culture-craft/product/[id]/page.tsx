    ...
    <div className="min-h-screen bg-gray-50 pt-20 pb-20">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 text-center">
          <h1 className="text-3xl font-serif font-bold text-gray-900 mb-4">Product Details</h1>
          <p className="text-gray-700 mb-8">Product ID: {id}</p>
          <p className="text-gray-600">This is a placeholder page for the product details.</p>
        </div>
      </div>
    </div>
  )
